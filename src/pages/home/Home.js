      ...
      <div className="container px">
        ...
        <div className="home__about">
          ...
          <div className="home-about__content">
            <h2>About Me</h2>
            <p>
              I’m a fullstack developer looking for a new role in an exciting
              company. I focus on writing accessible HTML, using modern CSS
              practices and writing clean JavaScript. When writing JavaScript
              code, I use React for the frontend and Node Js for the backend.
              I’m based in Nigeria but I’m happy working remotely and have
              experience in remote teams. When I’m not coding, you’ll find me
              playing video games or reading novels. I love being out in nature
